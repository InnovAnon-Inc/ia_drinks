...
function drinks.drinks_liquid_sub(liq_vol, ves_typ, ves_vol, pos, able_to_fill, leftover_count, outputstack)
   ...
   if ves_typ == 'jcu' or ves_typ == 'jbo' or ves_typ == 'jsb' or ves_typ == 'jbu' or ves_typ == 'jbw' then
   ...
   allow_metadata_inventory_put = function(pos, listname, index, stack, player)
      ...
      elseif listname == 'dst' then --removing liquid
         ...
         if juice ~= 'empty' then
            ...
            if valid == 'vessels' or valid == 'bucket:' or valid == 'wooden_bucket:' then
               return inputcount
            else
               return 0
            end
